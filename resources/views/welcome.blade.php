<x-layout>
    ...
    <section class="bg-[#262626] pt-12 lg:pt-0">
        ...
        <main
            class="mt-[130px] lg:mt-[-100px] 2xl:mt-[-180px] flex items-center lg:flex-row justify-center flex-col gap-[100px] md:gap-[40px] lg:gap-[100px] mx-auto w-full max-w-[1440px] min-w-[280px]  py-8 px-4 lg:px-8">
            <div class="max-w-[550px] mt-[-160px]">
                ...
                <p class="text-center text-xl mb-16 mt-5 text-amber-200">برنامج متكامل مخصص لإنشاء الاستبيانات وجمع آراء
                    المستخدمين بسهولة يتيح لك تصميم نماذج تفاعلية وتحليل النتائج بدقة لدعم اتخاذ القرارات المستندة إلى
                    البيانات.</p>

                <div class="flex flex-col items-center">
                    <button
                        class="my-3 w-full flex items-center justify-between outline-gray-600 max-w-[350px] text-xl  font-bold sm:text-lg  rounded-[38px] bg-[#fff] text-[#262626] py-4 px-6 sm:px-9"><a
                            href="/surveys">اظهار الاستبيانات</a><span></span><svg xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="#262626" height="20px" width="20px"
                            version="1.1" viewBox="0 0 330 330" xml:space="preserve">
                            <path id="XMLID_27_"
            ...
            <div
                class="grid grid-cols-2 gap-[24px] place-items-center
         p-[20px] md:p-[30px] lg:p-0
         lg:grid-cols-[250px_250px] lg:grid-rows-8 lg:gap-[45px] lg:mt-[-70px]">

                <!-- Card 1 -->
                <div
                    class="bg-white border-4 border-[#262626] aspect-[3/4] rounded-[40px] w-full max-w-[250px] p-5 md:p-4 lg:p-6 flex flex-col justify-between lg:col-start-1 lg:col-end-2 lg:row-start-1 lg:row-end-4 mr-auto">
                    ...
                    <div class="">
                        <span class="text-[40px] md:text-[48px] lg:text-[60px] font-bold text-[#F9B800] leading-tight">
                            1<span class="text-[#262626]">.</span>
                        </span>
                        <p class="text-sm md:text-base lg:text-xl text-[#262626]">
                            <span class="block font-bold">جمع احصائيات</span>
                            <span class="block">جمع وتحليل البيانات</span>
                        </p>
                    </div>
                </div>
                ...
                <!-- Card 2 -->
                <div
                    class="bg-[#F9B800] border-4 border-[#262626] aspect-[3/4] rounded-[40px] w-full max-w-[250px] p-5 md:p-4 lg:p-6 flex flex-col justify-between lg:col-start-2 lg:col-end-3 lg:row-start-2 lg:row-end-5 ml-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 24 24"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="">
                        <span class="text-[40px] md:text-[48px] lg:text-[60px] font-bold text-black leading-tight">
                            2<span class="text-white">.</span>
                        </span>
                        <p class="text-sm md:text-base lg:text-xl">
                            <span class="block font-bold">إضافة اسئلة خاصة</span>
                            <span class="block">يمكن إضافة الاسئلة التي ترغب بها بعدة طرق</span>
                        </p>
                    </div>
                </div>
                ...
                <!-- Card 4 -->
                <div
                    class="bg-white aspect-[3/4] rounded-[40px] w-full max-w-[250px] p-5 md:p-4 lg:p-6 flex flex-col justify-between lg:col-start-2 lg:col-end-3 lg:row-start-5 lg:row-end-8 ml-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 24 24"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="">
                        <span class="text-[40px] md:text-[48px] lg:text-[60px] font-bold text-[#F9B800] leading-tight">
                            4<span class="text-[#262626]">.</span>
                        </span>
                        <p class="text-sm md:text-base lg:text-xl text-[#262626]">
                            <span class="block font-bold">تصدير البيانات</span>
                            <span class="block">يمكن تصدير البيانات بعدة طرق</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="2xl:mt-[-360px]">
            <div class="rotate-180"><svg viewBox="0 0 1925 375" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.0021713 0L0.000976562 375.003L1925 0H0.0021713Z"
                        fill="#F9B800"></path>
                </svg></div>
            <div class="mt-[-0.5px]"><svg viewBox="0 0 1925 375" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M0.0021713 0L0.000976562 375.003L1925 0H0.0021713Z" fill="#F9B800"></path>
                </svg></div>
        </div>

        <div class="pb-20">
            <h2 class="text-center mb-32  text-7xl font-semibold text-white">خدماتنا</h2>
            <div class="">
                <div
                    ...
                    <div class="grid gap-4 justify-items-center text-center md:flex-1">
                        ...
                        <h3 class="text-3xl font-bold text-white">الامان</h3>
                        <p class="text-white">جميع الاحصائيات تكون محفظة لك فقط</p>
                    </div>
                    <div class="grid gap-4 justify-items-center text-center md:flex-1">
                        <div class=" rounded-full border-8 border-amber-400 p-4 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <h3 class="text-3xl font-bold text-white">الفعالية</h3>
                        <p class="text-white">توفر المنصة خصائص لتصحيح وجمع وتحليل اجابات المستخدمين</p>
                    </div>
                    <div class="grid gap-4 justify-items-center text-center md:flex-1">
                        <div class=" rounded-full border-8 border-amber-400 p-4 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <h3 class="text-3xl font-bold text-white">خبراتنا</h3>
                        <p class="text-white">لدينا فريق بخبرة عالية في مجال تحليل الاسئلة الاحصائية</p>
                    </div>
                </div>
            </div>
        </div>
